...
public class ConfigureFolderTest extends BaseTest {
    ...
    private static final By RECURSIVE = By.xpath("//input[@name='_.recursive']");
    ...
    public void testConfigureFolder(){
        ...
        getDriver().findElement(HEALTH_METRICS).click();
        Assert.assertTrue(getWait2().until(ExpectedConditions.presenceOfElementLocated(RECURSIVE)).isDisplayed());
