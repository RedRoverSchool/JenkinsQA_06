...
public class RenameFolderr1Test extends BaseTest{
    ...
    private static final By RENAME_BUTTON = By.xpath("//a[@href='/job/Project70/confirm-rename']");
    ...
    public void testRenameFolder(){
        ...
        Assert.assertTrue(getDriver().findElement(UPDATED_PROJECT_NAME_DISPLAYED).getText().contains(updateName));
    }
