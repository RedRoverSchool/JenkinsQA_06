...
public class ComradesAdelanteGroupTest extends BaseTest {
    ...
    public void CreateJobJenkinsTest() {
        ...
        WebElement generalInfoField = getDriver().findElement(By.xpath("//h2[contains(text(),'Общие настройки')]"));
        Assert.assertEquals(generalInfoField.getText(), "Общие настройки");
    }
}
