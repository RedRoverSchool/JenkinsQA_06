...
public class BugsBustersGroupTest extends BaseTest {
   ...
   @Test
    ...
    public void testHiddenButton() {
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id='job_test']/td[3]//button")));
        WebElement jobMenuButton = getDriver().findElement(By.xpath("//*[@id='job_test']/td[3]//button"));
        jobMenuButton.click();
