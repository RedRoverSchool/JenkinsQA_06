...
public class EvgenyZagrebelnikovTest {
    ...
    @Test
    public void testRzdGoogleSearch() throws InterruptedException {
        ...
        textBox.sendKeys("rzd");
        textBox.sendKeys(Keys.RETURN);

        Thread.sleep(2000);

        WebElement text = driver.findElement(By.xpath("//h3[text() = 'РЖД']"));

        Assert.assertEquals(text.getText(), "РЖД");
