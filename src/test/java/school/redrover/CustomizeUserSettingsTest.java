...
public class CustomizeUserSettingsTest extends BaseTest  {
    ...
    @Test
    public void testCredentialsEddElementID() throws InterruptedException {
        ...
        getDriver().findElement(By.cssSelector("[name='fullname']")).sendKeys(testUser);
        ...
        String oldactualresult = getDriver().findElement(By.cssSelector("#person-TestUser td:nth-child(3)")).getText();
        Assert.assertEquals(oldactualresult, testUser);
        ...
        String newactualresult = getDriver().findElement(By.cssSelector("#person-TestUser td:nth-child(3)")).getText();
