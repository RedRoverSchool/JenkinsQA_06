...
public class ViewPage extends BasePage {
    ...
    private static final By description = By.xpath("//div[@id='description']/child::*");
    private static final By stringSearchItemName = By.xpath("//input[@id = 'name']");
    private static final By pipelineProject = By.xpath("//span[normalize-space()='Pipeline']");
    private static final By saveButton = By.xpath("//button[@id = 'ok-button']");
    ...
    public ViewPage inputAnItemName(String text) {
        ...
        sendTextToInput((WebElement) stringSearchItemName, text);
        return new ViewPage(getDriver());
    }

    public ViewPage clickPipelineProject() {
        click((WebElement) pipelineProject);
        return new ViewPage(getDriver());
    }
    ...
    public String getDescriptionText() {
        return getText((WebElement)description);
    }
