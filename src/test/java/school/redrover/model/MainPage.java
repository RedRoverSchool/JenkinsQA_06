...
public class MainPage extends BasePage {
    ...
    private static final By newItemButton = By.xpath("//a[@href='/view/all/newJob']");
    private static final By playBuildForATestButton = By.xpath("//a[@href='job/New%20Builds/build?delay=0sec']");
    private static final By buildsHistoryButton = By.xpath("//a[@href='/view/all/builds']");
    private static final By adminLink = By.cssSelector(".login>a.model-link");
    ...
    public MainPage clickPlayBuildForATestButton() {
        click((WebElement) playBuildForATestButton);
        return new MainPage(getDriver());
    }

    public BuildPage clickBuildsHistoryButton() {
        click((WebElement) buildsHistoryButton);
        return new BuildPage(getDriver());
    }

    public ViewPage clickNewItemButton() {
        click((WebElement) newItemButton);
