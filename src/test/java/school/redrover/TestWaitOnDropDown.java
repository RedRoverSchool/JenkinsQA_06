...
public class TestWaitOnDropDown extends BaseTest {
    ...
    public void testTopMenuUserDropDown() {
        ...
        new WebDriverWait(getDriver(), Duration.ofSeconds(5)).until(ExpectedConditions.visibilityOfNestedElementsLocatedBy(By.xpath("//ul[@class='first-of-type']/li"), By.xpath("//a[contains(@href,'/user/')]")));
