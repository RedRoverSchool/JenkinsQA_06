...
public class MultibranchPipeline3Test extends BaseTest {
    ...
    public void testMoveMultibranchPipelineToFolder() {
        TestUtils.createFolder(this, "Folder1");
        ...
        TestUtils.createMultibranchPipeline(this, "MultibranchPipeline1");
        getWait2().until(ExpectedConditions.elementToBeClickable(By.xpath("//a[@href='job/MultibranchPipeline1/']/span"))).click();
