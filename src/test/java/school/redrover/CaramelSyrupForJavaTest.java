...
public class CaramelSyrupForJavaTest extends BaseTest {
    ...
    public static void testArtyomDulyaHeaderButton() throws InterruptedException {
        ...
        WebElement guide = driver.findElement(By.xpath("//ul//div//ul/li//a[text()='Guide']"));
        WebElement api = driver.findElement(By.xpath("//div[@id='desktop-menu']//a[@href='/api'][text()='API']"));
