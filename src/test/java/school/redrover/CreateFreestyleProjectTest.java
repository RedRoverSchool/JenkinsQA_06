...
public class CreateFreestyleProjectTest extends BaseTest {
    ...
    public void testCreateFreestyleProjectJob() {
        createFreestyleProjectJob(NAME_PROJECT);

        Assert.assertTrue(getWait2().until(ExpectedConditions.elementToBeClickable(CONSOLE_OUT)).getText().contains("Finished: SUCCESS"));
    }
}
